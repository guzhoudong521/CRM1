    ...
    <div class="in_bg">
      <table border="0" cellpadding="0" cellspacing="0" class="table_input txt">
        ...
        <tr>
          ...
          <td><form action="ser/dis.action" method="post" id="disform">
          <input type="hidden" name="id" value="${ser.id}">
          <textarea rows="6" cols="36" name="dispose"/></textarea>
          </form></td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          <td>处理人</td>
          <td><input type="text" value="${sessionScope.curruser.uname }" disabled="disabled"/></td>
          <td>处理时间</td>
